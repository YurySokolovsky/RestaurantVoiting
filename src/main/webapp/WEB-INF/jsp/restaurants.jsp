...
<div class="jumbotron pt-4">
    <div class="container">
        <h4><spring:message code="restaurant.title"/></h4>
        <br/>
            ...
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        <label for="restaurant_name" class="col-form-label"><spring:message code="restaurant.name"/></label>
                        <input type="text" class="form-control" id="restaurant_name" name="restaurantName"
