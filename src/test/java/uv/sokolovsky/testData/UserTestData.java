...
import static uv.sokolovsky.web.json.JsonUtil.writeIgnoreProps;
...
public class UserTestData {
    ...
    public static final User USER1 = new User(USER_ID, "User1", "user1@yandex.ru", "first_user", Role.ROLE_USER);
    public static final User USER2 = new User(USER_ID +1, "User2", "user2@mail.ru", "second_user", Role.ROLE_USER);
